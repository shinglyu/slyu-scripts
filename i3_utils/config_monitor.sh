...
COMMANDS["Built-in_display_only"]="xrandr --output eDP1 --auto; xrandr --output DP1 --off; xrandr --output HDMI-1 --off"
COMMANDS["Built-in+vertical_desktop_monitor(DVI)"]="xrandr --output eDP1 --auto; xrandr --output HDMI-1 --auto --right-of eDP1 --rotate left; i3-msg restart"
...
COMMANDS["Built-in+projector_extended(HDMI)"]="xrandr --output eDP1 --auto; xrandr --output HDMI-1 --auto --same-as eDP1; i3-msg restart"
COMMANDS["Built-in+projector_mirrior(HDMI)"]="xrandr --output eDP1 --auto; xrandr --output HDMI-1 --auto --same-as eDP1; i3-msg restart"
#COMMANDS["list files with detail"]="ls -l"
#COMMANDS["list files with detail"]="ls -l"
#COMMANDS["list files with detail"]="ls -l"
#COMMANDS["list files with detail"]="ls -l"
